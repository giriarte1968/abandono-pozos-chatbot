...
# ========================================
# INICIALIZAR ORACLE (Thin mode)
# ========================================
try:
    oracledb.init_oracle_client(config_dir=WALLET_DIR)
    st.success("Configuración Oracle cargada")
except Exception as e:
    st.error(f"Error config: {e}")

# ========================================
# CONEXIÓN (wallet_password AQUÍ)
# ========================================
@st.cache_resource
def get_connection():
    try:
...
# ========================================
# LLM (Ollama → cambiar por Groq)
# ========================================
def generate_explanation(query: str, context: str, source: str, distance: float):
    prompt = f"""
    Eres un experto en abandono de pozos. Responde claro.
    ...
    try:
        ...
        return "LLM no disponible (Ollama solo local)"
